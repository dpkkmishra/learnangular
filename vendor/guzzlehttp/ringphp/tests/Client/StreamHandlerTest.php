...
class StreamHandlerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDebugAttributeWritesToStream()
    {
        ...
        $this->assertContains('<GET //127.0.0.1:8125/> [CONNECT]', $contents);
        $this->assertContains('<GET //127.0.0.1:8125/> [FILE_SIZE_IS]', $contents);
        $this->assertContains('<GET //127.0.0.1:8125/> [PROGRESS]', $contents);
    }
    ...
    public function testDebugAttributeWritesStreamInfoToBuffer()
    {
        ...
        $this->assertContains('<GET //127.0.0.1:8125/> [CONNECT]', $contents);
        $this->assertContains('<GET //127.0.0.1:8125/> [FILE_SIZE_IS] message: "Content-Length: 8"', $contents);
        $this->assertContains('<GET //127.0.0.1:8125/> [PROGRESS] bytes_max: "8"', $contents);
