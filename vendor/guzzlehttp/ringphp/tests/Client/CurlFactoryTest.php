...
class CurlFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreatesCurlHandle()
    {
        ...
        $this->assertContains('host: //127.0.0.1:8125/', $_SERVER['_curl'][CURLOPT_HTTPHEADER]);
    }
    ...
    public function testAddsProxy()
    {
        ...
        $f([
            'http_method' => 'GET',
            'headers' => ['host' => ['foo.com']],
            'client' => ['proxy' => '//bar.com'],
        ]);
        $this->assertEquals('//bar.com', $_SERVER['_curl'][CURLOPT_PROXY]);
    }
    ...
    public function testAddsViaScheme()
    {
        ...
        $f([
            ...
            'headers' => ['host' => ['foo.com']],
            'client' => [
                'proxy' => ['http' => '//bar.com', 'https' => 'https://t'],
            ],
        ]);
        $this->assertEquals('//bar.com', $_SERVER['_curl'][CURLOPT_PROXY]);
    }
    ...
    public function testParsesLastResponseOnly()
    {
        ...
        $this->assertEquals('//127.0.0.1:8125/foo', $response['effective_url']);
