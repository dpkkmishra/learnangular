...
client
    ...
    debug
        ...
        using cURL to transfer requests, cURL's `CURLOPT_VERBOSE <//curl.haxx.se/libcurl/c/CURLOPT_VERBOSE.html>`_
        will be used. When using the PHP stream wrapper, `stream notifications <//php.net/manual/en/function.stream-notification-callback.php>`_
        will be emitted.
...
reason
    ...
    ``status`` code. See `RFC 7231 <//tools.ietf.org/html/rfc7231#section-6.1>`_
