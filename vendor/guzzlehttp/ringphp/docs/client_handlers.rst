...
`http stream wrapper <//php.net/manual/en/wrappers.http.php>`_ to send
requests.
...
associative array of `cURL option constants <//php.net/manual/en/curl.constants.php>`_
...
cURL's `multi API <//curl.haxx.se/libcurl/c/libcurl-multi.html>`_. The
