...
----
$hosts = [
    '//user:pass@localhost:9200',       // HTTP Basic Authentication
    '//user2:pass2@other-host.com:9200' // Different credentials on different host
];
...
If you are encountering problems, update your libcurl version and/or check the //curl.haxx.se/changes.html[curl changelog].
=================
